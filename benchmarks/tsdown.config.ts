...
export default defineConfig([
  {
    ...
    outDir: '.qilin-build/terminal-io',
    clean: true,
  ...
  },
  {
    ...
    outDir: '.qilin-build/active-stream-reconnect',
    clean: true,
  ...
  },
  {
    ...
    outDir: '.qilin-build/agent-continuation',
    clean: true,
    tsconfig: 'tsconfig.host.json',
  },
  {
    ...
    outDir: '.qilin-build/session-open',
    clean: true,
    tsconfig: 'tsconfig.host.json',
  },
  {
    ...
    outDir: '.qilin-build/conversation-fold',
    clean: true,
    tsconfig: 'tsconfig.client.json',
  },
])
