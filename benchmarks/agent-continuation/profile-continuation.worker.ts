...
async function run(root: string): Promise<ProfileReport> {
  ...
  await writeFile(patch, [
    ...
    '- insert:',
    '    - id: fs-local', "      name: '@qilin/fs-local'",
    '    - id: str-replace-editor', "      name: '@qilin/tool-str-replace-editor'",
...
assertBuiltBenchmarkRuntime(import.meta.url, { '@qilin/sdk-client': import.meta.resolve('@qilin/sdk-client') })
