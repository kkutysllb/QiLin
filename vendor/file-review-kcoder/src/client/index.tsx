 ...
 *    BEFORE @qilin/coding-sidebar's own -1 interception row (chain election is
...
import type {} from '@qilin/coding-sidebar/src/client/service.ts'
import type { ISessions, SessionId } from '@qilin/client-modules/client'
import type { RemoteResult } from '@qilin/typert-protocol'
import type { TabDescriptor } from '@qilin/coding-sidebar/src/client/service.ts'
import type {
...
export function apply(ctx: Context): void {
  ...
  // priority -2 runs BEFORE @qilin/coding-sidebar's -1 interception row: chain
