...
import { SettingsConflictError, type SettingsNamespace } from '@qilin/settings'
...
// Re-export the Context augmentation (`declare module '@qilin/kylin'`)
...
export const name = '@qilin/coding-sidebar'
