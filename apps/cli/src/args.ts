...
const HELP_EXAMPLES = `
Examples:
  qilin web                                   boot the web profile (same as: qilin --profile web)
 ...
 */
function resolveBoot(program: Command, profile: string, options: BootOptions, args: string[]): QilinInvocation {
