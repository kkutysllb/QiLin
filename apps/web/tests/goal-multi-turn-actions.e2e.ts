...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@qilin/client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@qilin/session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@qilin/token-meter"}\n',
