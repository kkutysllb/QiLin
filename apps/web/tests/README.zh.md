...
Client face，而该 face 必须等 Host tsdown 生成 `@qilin/goal/remote` 之后才能编译，
...
`@qilin/client-web` import `AppWebEntry`、从
`@qilin/client-modules/client` import boot manifest 类型：启动真实 shell 正是该
