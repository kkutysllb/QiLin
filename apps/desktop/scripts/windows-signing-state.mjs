...
export function beginWindowsSigningAttempt(options) {
  const runDirectory = options.runDirectory ?? process.env.QILIN_DESKTOP_PACKAGING_RUN_DIR
  ...
  const root = options.stateDirectory ?? join(homedir(), '.qilin-desktop-signing')
