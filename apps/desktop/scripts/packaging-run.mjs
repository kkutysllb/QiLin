...
const FATAL_NOTIFICATION = 'QILIN_DESKTOP_PACKAGING_FATAL'
...
export function createPackagingRun(root, metadata) {
  ...
  async function run(stage, executable, args, options) {
    ...
    try {
      ...
      child = spawn(executable, [...args], { cwd: options.cwd, env: { ...options.env, QILIN_DESKTOP_PACKAGING_RUN_DIR: directory },
