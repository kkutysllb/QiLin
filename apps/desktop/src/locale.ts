...
export const en = {
  ...
  startupFailed: 'QiLin could not start',
  startupLoading: 'Starting QiLin…',
  ...
  updateTitle: 'QiLin Update',
  updateAvailable: 'An update is available',
  updateDetail: 'QiLin {version}\n\nThis release includes its matching qilin version. The application will restart after installation.',
  installAndRestart: 'Install and Restart',
  later: 'Later',
  updateFailedTitle: 'Update Failed',
  pluginManagerTitle: 'Desktop Plugins',
  pluginWindowTitle: 'QiLin — Desktop Plugins',
...
export const zh = {
  application: '应用',
  startupFailed: 'QiLin 无法启动',
  startupLoading: '正在启动 QiLin…',
  ...
  updateTitle: 'QiLin 更新',
  updateAvailable: '发现可用更新',
  updateDetail: 'QiLin {version}\n\n新版本绑定匹配的 qilin，安装后将重新启动。',
  installAndRestart: '安装并重启',
  later: '稍后',
  updateFailedTitle: '更新失败',
  pluginManagerTitle: '桌面插件',
  pluginWindowTitle: 'QiLin — 桌面插件',
