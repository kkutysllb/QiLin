...
export const en = {
  ...
  startupFailed: 'QiLin is unavailable',
  ...
  updateDownloadedTitle: 'QiLin v{version} downloaded',
...
export const zh = {
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: 'QiLin v{version} 下载完成',
