...
export const UPDATE_DIALOG_IPC = { status: 'qilin-update-dialog:status', respond: 'qilin-update-dialog:respond' } as const
...
const page = 'qilin-app://shell/update-dialog.html'
