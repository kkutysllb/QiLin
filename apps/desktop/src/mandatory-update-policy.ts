...
export interface DesktopPolicyIdentity {
  ...
  readonly bundledQilinVersion: string
...
export class DesktopMandatoryUpdatePolicy {
  ...
  constructor(
    ...
    if (valid(identity.version) === null || valid(identity.bundledQilinVersion) === null || identity.bundleId.trim() === ''
    ...
    this.headers = Object.freeze({
      ...
      'x-client-bundled-qilin-version': identity.bundledQilinVersion,
    })
  }
