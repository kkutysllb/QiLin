...
mkdirSync('.qilin', { recursive: true })
...
lines.on('line', line => {
  ...
  switch (request.method) {
    case 'server/discover':
      ...
      return
    case 'initialize':
      writeFileSync('.qilin/browser-fixture.started', 'chrome-devtools-mcp\n', { flag: 'wx' })
      process.once('exit', () => unlinkSync('.qilin/browser-fixture.started'))
