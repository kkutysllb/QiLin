...
There is no framework bootstrap code in your file: a plugin describes what it contributes, and `kylin.yml` composes the application. The [`qilin` base](../../packages/bundle/base/kylin.patch.yml), for example, is a longer plugin composition that deployment overlays patch.
