...
<a id="deepseek-aiqilin-client-ui-sidebar-documentpreview"></a>
...
<a id="deepseek-aiqilin-office-to-pdf"></a>
...
<a id="deepseek-aiqilin-skill-office"></a>
...
<a id="deepseek-aiqilin-subagent"></a>
...
<a id="deepseek-aiqilin-workspace-changes"></a>
...
- `@qilin/tool-cordis` — 需要 `tools` · `systemPrompt` · `cordisInspect`（[`packages/extensions/tool-cordis/src/index.ts`](../packages/extensions/tool-cordis/src/index.ts)）
