...
These diagrams show relationships that the generated catalogs do not. Use them to find package relationships, capability seams, event flow, model-facing tools, app composition, and runtime lifecycle paths. Exact signatures and type definitions still live in the [subsystem pages](subsystems/core.md) (types + the generated Kylin API regions) and [tool-catalog.md](tool-catalog.md).
...
| [qilin shared base composition](../apps/cli/composition.md) | `hybrid generated` |
