...
Creator mode provides [Plugin Manager](../../../../packages/boot/plugin-manager/README.md) and read-only [runtime inspection](../../../../packages/extensions/tool-kylin/README.md). Plugin configuration belongs to the current profile, affects its sessions, and survives process restarts.
