...
The command requires a model credential. The [Cordis tool reference](../../../../packages/extensions/tool-kylin/README.md) defines the tool arguments, lifetime, cleanup, and safety contracts.
