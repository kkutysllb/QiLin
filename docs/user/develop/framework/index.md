...
With `@qilin/kylin-plugin-hmr` loaded from `cordis.yml`, editing a plugin source file triggers:
...
- [Kylin tutorial](../../../cordis-tutorial/index.md) — the same lifecycle, services, and events built step by step against the Kylin runtime
