---
description: "Retrospective Session persistence types and adjacent-release changes for qilin-v0.0.1-rc.5."
kind: persistence-release
---

# Persistence release: qilin-v0.0.1-rc.5

English | [中文](qilin-v0.0.1-rc.5.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `qilin-v0.0.1-rc.5` |
| Source date | 2026-08-12T22:18:58.000Z |
| Release record | Tag only; no release object. |
| Previous release | [qilin-v0.0.1-rc.4](qilin-v0.0.1-rc.4.md) |
...
| This snapshot | [qilin-v0.0.1-rc.5.schema.json](qilin-v0.0.1-rc.5.schema.json) |
...
schemaVersion: 1
tag: qilin-v0.0.1-rc.5
previous: qilin-v0.0.1-rc.4
