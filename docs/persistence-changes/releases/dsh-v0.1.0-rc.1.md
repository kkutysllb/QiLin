---
description: "Retrospective Session persistence types and adjacent-release changes for qilin-v0.1.0-rc.1."
kind: persistence-release
---

# Persistence release: qilin-v0.1.0-rc.1

English | [中文](qilin-v0.1.0-rc.1.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `qilin-v0.1.0-rc.1` |
| Source date | 2026-08-13T08:51:36.000Z |
| Release record | Tag only; no release object. |
| Previous release | [qilin-v0.0.1-rc.5](qilin-v0.0.1-rc.5.md) |
...
| This snapshot | [qilin-v0.1.0-rc.1.schema.json](qilin-v0.1.0-rc.1.schema.json) |
...
schemaVersion: 1
tag: qilin-v0.1.0-rc.1
previous: qilin-v0.0.1-rc.5
