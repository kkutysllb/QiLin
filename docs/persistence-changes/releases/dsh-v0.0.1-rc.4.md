---
description: "Retrospective Session persistence types and adjacent-release changes for qilin-v0.0.1-rc.4."
kind: persistence-release
---

# Persistence release: qilin-v0.0.1-rc.4

English | [中文](qilin-v0.0.1-rc.4.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `qilin-v0.0.1-rc.4` |
| Source date | 2026-08-12T21:29:23.000Z |
| Release record | Tag only; no release object. |
| Previous release | [qilin-v0.0.1-rc.3](qilin-v0.0.1-rc.3.md) |
...
| This snapshot | [qilin-v0.0.1-rc.4.schema.json](qilin-v0.0.1-rc.4.schema.json) |
...
schemaVersion: 1
tag: qilin-v0.0.1-rc.4
previous: qilin-v0.0.1-rc.3
