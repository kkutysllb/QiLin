---
description: "Retrospective Session persistence types and adjacent-release changes for qilin-v0.0.1-rc.1."
kind: persistence-release
---

# Persistence release: qilin-v0.0.1-rc.1

English | [中文](qilin-v0.0.1-rc.1.zh.md)

## Summary

This is the earliest available QILIN alpha/rc tag and establishes the historical baseline: 42 persistence roots and writer format 0.
...
| This snapshot | [qilin-v0.0.1-rc.1.schema.json](qilin-v0.0.1-rc.1.schema.json) |
