---
description: "Retrospective Session persistence types and adjacent-release changes for qilin-v0.1.2-alpha.5."
kind: persistence-release
---

# Persistence release: qilin-v0.1.2-alpha.5

English | [中文](qilin-v0.1.2-alpha.5.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `qilin-v0.1.2-alpha.5` |
| Source date | 2026-09-02T07:57:43.000Z |
| Release record | Release object present. |
| Previous release | [qilin-v0.1.2-alpha.4](qilin-v0.1.2-alpha.4.md) |
...
| This snapshot | [qilin-v0.1.2-alpha.5.schema.json](qilin-v0.1.2-alpha.5.schema.json) |
...
schemaVersion: 1
tag: qilin-v0.1.2-alpha.5
previous: qilin-v0.1.2-alpha.4
