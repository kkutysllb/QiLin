---
description: "Retrospective Session persistence types and adjacent-release changes for qilin-v0.1.2-alpha.3."
kind: persistence-release
---

# Persistence release: qilin-v0.1.2-alpha.3

English | [中文](qilin-v0.1.2-alpha.3.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `qilin-v0.1.2-alpha.3` |
| Source date | 2026-08-31T15:53:17.000Z |
| Release record | Release object present. |
| Previous release | [qilin-v0.1.2-alpha.2](qilin-v0.1.2-alpha.2.md) |
...
| This snapshot | [qilin-v0.1.2-alpha.3.schema.json](qilin-v0.1.2-alpha.3.schema.json) |
...
schemaVersion: 1
tag: qilin-v0.1.2-alpha.3
previous: qilin-v0.1.2-alpha.2
