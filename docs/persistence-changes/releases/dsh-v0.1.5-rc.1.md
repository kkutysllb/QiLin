---
description: "Retrospective Session persistence types and adjacent-release changes for qilin-v0.1.5-rc.1."
kind: persistence-release
---

# Persistence release: qilin-v0.1.5-rc.1

English | [中文](qilin-v0.1.5-rc.1.zh.md)
...
| Item | Recorded value |
|---|---|
| Source tag | `qilin-v0.1.5-rc.1` |
| Source date | 2026-09-10T01:36:48.000Z |
| Release record | Release object present. |
| Previous release | [qilin-v0.1.5-alpha.2](qilin-v0.1.5-alpha.2.md) |
...
| This snapshot | [qilin-v0.1.5-rc.1.schema.json](qilin-v0.1.5-rc.1.schema.json) |
...
schemaVersion: 1
tag: qilin-v0.1.5-rc.1
previous: qilin-v0.1.5-alpha.2
