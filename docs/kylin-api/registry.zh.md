<!-- 英文源文件由 scripts/gen-kylin-catalog.ts 生成；本中文文件是通过双语配对维护的经评审对侧。
     更新时先运行 `pnpm run gen-kylin-catalog` 更新英文，再更新本文件并运行 `pnpm run verify-translation-pairing --write docs/kylin-api/registry.md` 重新记录配对。 -->
...
[源码](../../vendor/kylin/src/registry.ts#L176)
...
[源码](../../vendor/kylin/src/registry.ts#L185)
...
[源码](../../vendor/kylin/src/registry.ts#L92)
...
[源码](../../vendor/kylin/src/registry.ts#L19)
