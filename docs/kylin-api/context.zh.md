<!-- 英文源文件由 scripts/gen-kylin-catalog.ts 生成；本中文文件是通过双语配对维护的经评审对侧。
     更新时先运行 `pnpm run gen-kylin-catalog` 更新英文，再更新本文件并运行 `pnpm run verify-translation-pairing --write docs/kylin-api/context.md` 重新记录配对。 -->

# 上下文

[English](context.md) | 中文

上下文是 Kylin 的核心对象：所有服务、事件和生命周期 API 都通过 `ctx` 访问。事件方法见[事件](events.zh.md)，副作用与当前 fiber 见 [Fiber](fiber.zh.md)，插件加载见[注册表](registry.zh.md)。

Kylin 插件的根依赖容器和子依赖容器。

上下文是一个代理：普通属性读取通过服务解析器进行，而 `extend()`、`isolate()` 和 `intercept()` 会创建有作用域的子上下文，且不修改其父上下文。

[源码](../../vendor/kylin/src/context.ts#L42)
...
[源码](../../vendor/kylin/src/context.ts#L99)
...
[源码](../../vendor/kylin/src/context.ts#L121)
...
[源码](../../vendor/kylin/src/context.ts#L139)
...
[源码](../../vendor/kylin/src/context.ts#L22)
...
[源码](../../vendor/kylin/src/context.ts#L24)
...
[源码](../../vendor/kylin/src/context.ts#L26)
...
[源码](../../vendor/kylin/src/context.ts#L28)
...
[源码](../../vendor/kylin/src/context.ts#L30)
...
[源码](../../vendor/kylin/src/context.ts#L32)
...
[源码](../../vendor/kylin/src/context.ts#L44)
...
[源码](../../vendor/kylin/src/context.ts#L46)
...
[源码](../../vendor/kylin/src/context.ts#L48)
...
[源码](../../vendor/kylin/src/context.ts#L50)

### Context.is(value)

```ts kylin-catalog
/**
 * Returns true for Kylin context proxies and context prototypes.
 *
 * Works across realms and across multiple copies of kylin, because the
 * brand is keyed by a global symbol rather than by `instanceof`.
 *
 * @param value — the value to test.
 * @returns `true` if `value` is a Kylin context, narrowing its type.
 */
static is(value: any): value is Context
```

对于 Kylin 上下文代理和上下文原型，返回 true。

此方法可跨 realm 和多个 kylin 副本工作，因为其品牌标识以全局 symbol 为键，而不是通过 `instanceof` 判断。

- `value`：要测试的值。

**返回** `true` 时，`value` 是 Kylin 上下文，并会收窄其类型。

[源码](../../vendor/kylin/src/context.ts#L61)
...
[源码](../../vendor/kylin/src/reflect.ts#L17)
...
[源码](../../vendor/kylin/src/reflect.ts#L29)
...
[源码](../../vendor/kylin/src/reflect.ts#L44)
...
[源码](../../vendor/kylin/src/reflect.ts#L56)
...
[源码](../../vendor/kylin/src/reflect.ts#L67)
