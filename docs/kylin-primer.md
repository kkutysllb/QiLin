...
Kylin is QiLin's plugin framework, vendored from upstream Cordis. This primer teaches the Kylin ideas a harness plugin author needs before reading the generated service/event reference on the [subsystem pages](subsystems/core.md); the [Kylin tutorial](kylin-tutorial/index.md) walks the same ideas hands-on. The vendored source and sync procedure live in [vendor/README.md](../vendor/README.md).
