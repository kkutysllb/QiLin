...
| [extensions.md](extensions.zh.md) | 带版本的动态 Kylin Plugin 与 Package、Host/Client 激活、审批、运行时检查和生命周期撤销 |
...
| [client-resources.md](client-resources.zh.md) | 客户端资源模型：`qilin-resource://<type>/…` 地址、协议提供方与 `ResourceProtocolMap`、`useResource` 全局 hook 及其状态、钉住与释放 |
