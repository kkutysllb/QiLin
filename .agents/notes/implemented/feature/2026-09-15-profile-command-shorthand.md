...
This decision supersedes the Web-only shorthand mechanism in [one qilin application launcher](../architecture/2026-08-22-single-dsh-application-launcher.md); that note retains authority over application composition and lifecycle ownership.
