...
- **精简的工作流 skill（技能），约定归文档。**[.agents/skills/qilin-doc](../../../skills/qilin-doc/SKILL.md) 承载文档放置、审计、预算与站点发布工作流，并以文档标准为真源，与 [dsh-translate-docs](../../../skills/qilin-translate-docs/SKILL.md) 和 i18n 约定之间的分工相同。
