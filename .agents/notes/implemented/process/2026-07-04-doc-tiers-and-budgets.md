...
- **A thin workflow skill, contracts in docs.** [.agents/skills/qilin-doc](../../../skills/qilin-doc/SKILL.md) carries the placement, audit, budget, and website workflow and defers to the standard as its source of truth, the same split as [dsh-translate-docs](../../../skills/qilin-translate-docs/SKILL.md) over the i18n contract.
