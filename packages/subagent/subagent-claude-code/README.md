...
- [Generated configuration catalog](../../../docs/config-catalog.md#deepseek-aiqilin-subagent-claude-code) — every accepted config field and its source declaration.
