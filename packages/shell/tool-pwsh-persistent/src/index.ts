 ...
 * @module @qilin/tool-pwsh-persistent
 */
...
const SHELL_PROMPT = '__QILIN_PERSISTENT_PWSH_PROMPT__ '
...
function markers(): CommandMarkers {
  ...
  return {
    start: `__QILIN_PERSISTENT_PWSH_START_${nonce}__`,
    end: `__QILIN_PERSISTENT_PWSH_END_${nonce}:`,
  }
}
