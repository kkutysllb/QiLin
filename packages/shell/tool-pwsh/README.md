...
- [Generated tool catalog](../../../docs/tool-catalog.md#deepseek-aiqilin-tool-pwsh) — the exact `pwsh` argument schema.
- [Generated configuration catalog](../../../docs/config-catalog.md#deepseek-aiqilin-tool-pwsh) — every accepted config field and its source declaration.
...
The model sees the generated [`pwsh` schema](../../../docs/tool-catalog.md#deepseek-aiqilin-tool-pwsh). Agent-scoped tool restrictions can remove the definition for that agent.
