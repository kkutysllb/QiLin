...
import { DSH_ENV_PREFIX } from '@qilin/shell'
import type { DshEnvironment, DshEnvironmentKey } from '@qilin/shell'
import { DSH_HOME_ENV, resolveDshHome } from '@qilin/home-paths'
...
export interface Config {
  /** DeepSeek Harness home directory exposed as `DSH_HOME`; defaults to `$DSH_HOME` or `~/.qilin`. */
  dshHome?: string
}
