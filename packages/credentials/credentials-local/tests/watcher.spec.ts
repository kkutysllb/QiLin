...
const KEY = credentialRef('QILIN_CRED_PIPE')
...
async function tempDir(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'qilin-credentials-watch-'))
