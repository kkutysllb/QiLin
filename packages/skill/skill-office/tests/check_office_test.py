...
S = "http://schemas.openxmlformats.org/spreaqilineetml/2006/main"
...
STRICT_S = "http://purl.oclc.org/ooxml/spreaqilineetml/main"
...
class OfficeCheckTest(unittest.TestCase):
    def setUp(self):
        self.directory = tempfile.TemporaryDirectory(prefix="qilin-office-check-")
    ...
    def package(self, suffix, parts, compression=zipfile.ZIP_STORED):
        primary, mime = {
            ...
            "xlsx": ("xl/workbook.xml", "spreaqilineetml.sheet.main+xml"),
        }[suffix]
