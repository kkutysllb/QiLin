...
The generated [configuration catalog](../../../docs/config-catalog.md#deepseek-aiqilin-sandbox-local) is the exhaustive source for every accepted field and its JSDoc.
