...
import { ERROR_BROKEN_PIPE } from '@qilin/win32-process/src/abi.ts'
import { processInformationType } from '@qilin/win32-process/src/ffi.ts'
...
function scratch(): string {
  const dir = mkdtempSync(join(tmpdir(), 'qilin-acl-index-'))
