...
import { SandboxUnavailableError, classifyRunnerFailure, isRunnerSpawnFailure } from '@qilin/sandbox'
import type { ConfinedArgv, SandboxExecutionPolicy, SandboxMode } from '@qilin/sandbox'
...
const STRIP_PREFIX = 'async function __qilin_program__() {\n'
const STRIP_SUFFIX = '\n}'
