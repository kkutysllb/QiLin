...
生成的[配置目录](../../../docs/config-catalog.zh.md#deepseek-aiqilin-api-workspace-files)是每个可接受字段及其 JSDoc 的完备来源。
...
- [工作区路径辅助](../../util/workspace-path/README.zh.md)——`fileAddressFor` 与 `parseFileAddress`，两端共享的 `qilin-resource://file/…` 地址语法。
