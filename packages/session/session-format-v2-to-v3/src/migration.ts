...
import { SessionFormatError, SessionFormatUnsupportedMigrationError, defineSessionFormatMigration, sessionFormatCount } from '@qilin/session-format'
import type { SessionFormatEvent, SessionFormatEventRun, SessionFormatJsonObject, SessionFormatJsonValue, SessionFormatMigrationContext, SessionFormatMigrationStage, SessionFormatMigrationStageInput } from '@qilin/session-format'
import { assertReleasedV2Header } from '@qilin/session-format-v1-to-v2'
...
export const sessionFormatV2ToV3 = defineSessionFormatMigration({
  name: '@qilin/session-format-v2-to-v3',
  fromVersion: 2,
  toVersion: 3,
  ...
  private emitSystem(prompt: string, anchor: SessionFormatEvent, context: SessionFormatMigrationContext): void {
    ...
    context.emitEvent(canonicalizeTransformedEvent({
      ...
      data: {
        ...
        message: {
          id,
          role: 'system', source: { kind: 'plugin', plugin: '@qilin/system-prompt' },
