...
本插件注入 `storageDomain`、`sessionProjections` 与 `sessions`。生成的[配置目录](../../../docs/config-catalog.zh.md#deepseek-aiqilin-session-projection-cache)是每个受支持字段及其 JSDoc 的穷尽式真源。
