...
import type { ImageAttachmentRef, ImageMediaType, RequestImageAttachment } from '@qilin/attachment'
import { createUserMessage, ToolCallId, ReasoningEffortId, createMessage } from '@qilin/llm'
