...
- [SDK application bundle](../bundle/sdk-app/README.md) — the `qilin --profile sdk` application that boots the JSON-RPC server.
...
- [SDK subagent provider](../subagent/subagent-qilin-sdk/README.md) — a harness-internal consumer of the TypeScript client.
