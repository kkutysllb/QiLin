...
The [`QilinConfigTreeDeclaration`](../../util/package-manifest/README.md) type describes each `qilin.configTrees` entry; this packer validates it and resolves its source directory.
