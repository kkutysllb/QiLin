"""CPython bootstrap for qilin-ptc-runtime-python.
...
class ProtocolChannel:
    ...
    def read_frame(
        ...
        (``boot`` and ``run``), where blocking is what the hanqilinake wants. Reply
...
def _model_traceback(exc: BaseException, max_bytes: int) -> str:
    ...
    def emit():
        ...
        if truncated:
            yield f"[qilin-ptc-runtime-python] exception chain truncated at {_MAX_TRACEBACK_CHAIN} links\n"
