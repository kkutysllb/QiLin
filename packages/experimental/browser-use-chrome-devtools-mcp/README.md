...
The [configuration catalog](../../../docs/config-catalog.md#deepseek-aiqilin-experimental-browser-use-chrome-devtools-mcp) lists accepted fields. The profile or preset selects the browser mode.
