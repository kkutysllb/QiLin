/**
 * Package-owned invariant companion for `@qilin/agent-presets`.
...
import { leakedServices, livePresetMounts } from '@qilin/agent-presets'

const PACKAGE_NAME = '@qilin/agent-presets'
