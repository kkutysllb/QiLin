...
import { createSystemMessage, createUserMessage, ToolCallId, createMessage, createToolResultMessage, MessageId, ReasoningEffortId } from '@qilin/llm'
import SessionStore, {
  adoptSessionEvent,
  ...
  it('adopts a system/message by freezing its message', () => {
    const event = {
      ...
      data: {
        turn: 1,
        step: 1,
        message: createSystemMessage('You are terse.', '@qilin/system-prompt'),
      },
    } as unknown as SessionEvent
