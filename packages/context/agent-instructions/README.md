...
| `qilinHome` | `$QILIN_HOME` or `~/.qilin` | Directory containing the user-global `AGENTS.md` |

The generated [configuration catalog](../../../docs/config-catalog.md#deepseek-aiqilin-agent-instructions) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated configuration catalog](../../../docs/config-catalog.md#deepseek-aiqilin-agent-instructions) — every accepted config field and its source declaration.
