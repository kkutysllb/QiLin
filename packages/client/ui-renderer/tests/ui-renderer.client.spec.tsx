...
describe('UI renderer plugin', () => {
  ...
  it('hydrates the boot page before switching to the assembled application', async () => {
    ...
    slots.register({ name: 'root' }, () => <div data-testid="root-probe" />)
    const el = container()
    el.innerHTML = '<div class="boot" data-qilin-boot=""><div><div class="spinner" data-qilin-boot-spinner="" style="--qilin-boot-arc: 180deg"></div><div>Loading plugins…</div></div></div>'
