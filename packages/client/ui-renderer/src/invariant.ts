/**
 * Package-owned invariant companion for `@qilin/client-ui-renderer`.
 * @module @qilin/client-ui-renderer/invariant
 */
...
import type { SlotMap } from '@qilin/client-ui-slots'
import type { InvariantInstaller } from '@qilin/invariants'

const PACKAGE_NAME = '@qilin/client-ui-renderer'
