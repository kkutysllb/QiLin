---
description: "Archived-session Settings page for the qilin web client: the registry-global archive set as a searchable list with one Unarchive action per row."
kind: "package-reference"
---

# @qilin/client-ui-settings-unarchive-sessions
...
Open Settings and select **Archived sessions** to see the sessions currently hidden from every grouping surface. Mount `@qilin/client-ui-settings-unarchive-sessions` in a Web composition that already provides the settings shell, the Workspace service, and the Session list; the page registers its own navigation entry and needs no configuration.
