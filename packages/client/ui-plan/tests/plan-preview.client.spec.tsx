...
describe('submitted plan identity', () => {
  ...
  it('round-trips opaque identifiers and refuses malformed addresses', () => {
    ...
    for (const address of ['file:///plan.md', 'qilin-resource://plan/s/c/extra', 'qilin-resource://plan/s/%XX', 'qilin-resource://plan/s/c?text=x',
      'qilin-resource://plan//c', 'qilin-resource://plan/subagent/p/c/invalid/call', 'qilin-resource://plan/subagent/p/c/one-shot']) {
