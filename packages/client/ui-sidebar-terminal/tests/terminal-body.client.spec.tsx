...
import type { TerminalViewState } from '@qilin/api-terminal-controller/client'
...
function mount(initial: TerminalViewState | undefined = idle, dictionary = en) {
  ...
  let visible = true
  let theme: ThemeSnapshot = { preference: 'light', fontSize: 14, leading: 0, active: { id: 'light', colorScheme: 'light', tokens: {} }, themes: [], revision: 0 }
  const detach = vi.fn()
  const model = {
