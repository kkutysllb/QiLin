...
import { Button, IconChevronDownOutline14, Modal } from '@qilin/client-ui-primitives'
...
export function ChatView({
  ...
  sessionId, openFile, openSkill, openTrajectory, loadOlder, loadThrough, loadImage, chatScroll, forkAt, fileMentions,
