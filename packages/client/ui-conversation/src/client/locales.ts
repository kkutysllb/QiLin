...
export const zh = {
  ...
  'settings.width.description': '会话消息区域的宽度；也可以直接拖动消息区两侧的手柄',
  ...
  'hero.headline': 'QiLin',
  'hero.tagline': '以仁为界，以灵为智，以中为枢，以瑞为果',
  'hero.greeting.morning': '早上好，新的一天，新的开始',
  'hero.greeting.afternoon': '下午好，愿你工作顺利',
  'hero.greeting.evening': '晚上好，今天辛苦了',
  ...
  'error.sessionInUse': '当前会话已被占用，可能是其他正在运行的 QILIN 导致的（如其他 qilin web、桌面端），请退出其他正在运行的 QILIN 后重试。',
...
export const en = {
  ...
  'settings.width.title': 'Message width',
  'settings.width.description': 'How wide the message area is; you can also drag the handles on either side of it',
  'settings.width.adaptive': 'Adaptive',
  'settings.width.unit': 'px',
  'settings.width.increase': 'Widen message area',
  'settings.width.decrease': 'Narrow message area',
  'settings.width.customize': 'Set a custom message area width',
  'settings.width.reset': 'Adaptive',
  'hero.headline': 'QiLin',
  'hero.tagline': 'Benevolence sets the bounds, spirit the wisdom, the center the pivot, auspiciousness the fruit',
  'hero.greeting.morning': 'Good morning, a fresh start to a new day',
  'hero.greeting.afternoon': 'Good afternoon, hope your work goes well',
  'hero.greeting.evening': 'Good evening, great job today',
  ...
  'error.sessionInUse': 'This session is already in use, possibly by another running QILIN instance (such as qilin web or the desktop app). Quit other running QILIN instances and try again.',
