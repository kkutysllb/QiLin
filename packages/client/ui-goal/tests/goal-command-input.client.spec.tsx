...
import { commandDefinition } from '@qilin/client-ui-chat/src/client/conversation-nodes/command.ts'
import { chatViewDefinition } from '@qilin/client-ui-chat/src/client/conversation-nodes/chat-snapshot-builder.ts'
