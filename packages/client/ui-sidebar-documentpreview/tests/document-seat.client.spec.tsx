...
import { apply as resourcesApply, inject as resourcesInject } from '@qilin/client-resources/src/client/index.ts'
import { apply as sidebarApply, inject as sidebarInject } from '@qilin/client-ui-sidebar-right/src/client/index.ts'
