...
/** Browser Worker ownership, hanqilinake, and PDF.js teardown under controlled completions. */
...
describe('PDF Worker lifecycle', () => {
  ...
  it('cancels startup before the worker hanqilinake without invoking PDF.js', async () => {
    const h = setup()
    h.controller.abort()
