 ...
 * comparison at a time. It claims the `qilin-resource://changes-review/session/…`
...
export const CHANGES_REVIEW_ID = '@qilin/client-ui-deliverables'
...
export function changesReviewDefinition(t: TranslateNS<typeof NS>): SidebarRightTabDefinition {
  return {
    ...
    patterns: ['qilin-resource://changes-review/**'],
    priority: 'builtin',
