...
export const zh = {
  ...
  'view.trajectoryGraph': '轨迹图',
  'guide.graphDescription': '把轨迹账本画成节点与边的实时流动图',
  'graph.toolbar': '轨迹图工具栏',
  'graph.fit': '适应视图',
  'graph.follow': '跟随最新',
  'graph.pause': '暂停流动',
  'graph.resume': '继续流动',
  ...
  'graph.parameters': '参数',
  'graph.result': '结果',
  'graph.closeDetails': '关闭详情',
  'graph.unrecorded': '未记录',
  'graph.stats.nodes': '{count} 节点',
  'graph.stats.edges': '{count} 边',
  'graph.stats.turns': '{count} 轮',
  'graph.stats.tokens': '{count} 令牌',
  'graph.lane.input': '输入',
  'graph.lane.model': '模型',
  'graph.lane.tool': '工具',
  'graph.context.inject': '注入',
  'graph.context.recall': '召回',
  'graph.status.idle': '空闲',
  'graph.status.running': '进行中',
  'graph.status.interrupted': '已中断',
  'graph.node.system': '系统提示词',
  'graph.node.user': '用户消息',
  'graph.node.steering': '插话',
  'graph.node.context': '上下文',
  'graph.node.command': '命令',
  'graph.node.request': '模型请求',
  'graph.node.compactionRequest': '压缩请求',
  'graph.node.assistant': '助手消息',
  'graph.node.streaming': '流式输出',
  'graph.node.compaction': '上下文压缩',
  'graph.node.retryScheduled': '等待重试',
  'graph.node.retryStarted': '重试中',
  'graph.node.retryCancelled': '重试已取消',
  'graph.node.error': '错误',
  'graph.node.maxTokens': '输出上限',
  'graph.node.tool': '工具',
  'graph.node.runningCall': '调用中',
  'graph.node.unknown': '未知事件',
} as const
...
export const en: Record<TrajectoryKey, string> = {
  ...
  'view.trajectoryGraph': 'Trajectory graph',
  'guide.graphDescription': 'The trajectory ledger drawn as a live node and edge flow',
  'graph.toolbar': 'Trajectory graph toolbar',
  'graph.fit': 'Fit view',
  'graph.follow': 'Follow latest',
  'graph.pause': 'Pause flow',
  'graph.resume': 'Resume flow',
  'graph.canvas': 'Trajectory graph canvas',
  ...
  'graph.tokens': 'Tokens',
  'graph.parameters': 'Arguments',
  'graph.result': 'Result',
  'graph.closeDetails': 'Close details',
  'graph.unrecorded': 'Not recorded',
  'graph.stats.nodes': '{count} nodes',
  'graph.stats.edges': '{count} edges',
  'graph.stats.turns': '{count} turns',
  'graph.stats.tokens': '{count} tokens',
  'graph.lane.input': 'Input',
  'graph.lane.model': 'Model',
  'graph.lane.tool': 'Tool',
  'graph.context.inject': 'Injected',
  'graph.context.recall': 'Recalled',
  'graph.status.idle': 'Idle',
  'graph.status.running': 'Running',
  'graph.status.interrupted': 'Interrupted',
  'graph.node.system': 'System prompt',
  'graph.node.user': 'User message',
  'graph.node.steering': 'Steering message',
  'graph.node.context': 'Context',
  'graph.node.command': 'Command',
  'graph.node.request': 'Model request',
  'graph.node.compactionRequest': 'Compaction request',
  'graph.node.assistant': 'Assistant message',
  'graph.node.streaming': 'Streaming',
  'graph.node.compaction': 'Compaction',
  'graph.node.retryScheduled': 'Retry scheduled',
  'graph.node.retryStarted': 'Retry started',
  'graph.node.retryCancelled': 'Retry cancelled',
  'graph.node.error': 'Error',
  'graph.node.maxTokens': 'Output cap',
  'graph.node.tool': 'Tool',
  'graph.node.runningCall': 'Running call',
  'graph.node.unknown': 'Unknown event',
}
