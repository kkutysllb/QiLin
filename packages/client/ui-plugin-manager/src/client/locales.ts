...
export const zh = {
  ...
  installSpecPlaceholder: '例如 @qilin/experimental-auto-review',
  installGuideToggle: '不知道该填什么？',
  installGuideHide: '收起引导',
  installGuideIntro: '从插件的 README 或发布页面复制以下任意一项。',
  installGuideIdNote: '包名即 npm 包名，常见形式为 qilin-xxx 或 @作者/插件名；插件的显示名称不是包名。',
  installGuideIdTitle: '包名',
  installGuideIdExample: '@qilin/experimental-auto-review',
  installGuideIdHint: 'README 安装命令中 qilin plugin add 或 pnpm add 之后的部分。',
  installGuideGitTitle: 'GitHub 仓库地址',
  installGuideGitExample: 'https://github.com/author/qilin-plugin',
  ...
  installGuideSafety: '请确认插件来源可信。插件在本机以你的权限运行，来源不明的插件可能损坏 QiLin，或读取和泄露你的数据。',
  installRun: '安装',
  ...
  reasonStopProfile: '这个 profile 没有启用 HMR，正在使用的包要停止后用 qilin plugin 卸载',
  ...
  updatesCurrent: '已是最新。',
  updatesClose: '关闭更新结果',
  updatesVersions: '{current} → {latest}',
  updatesFailed: '检查更新失败：{reason}',
  versionUnknown: '未知版本',
  update: '更新',
  updateLabel: '更新 {name}',
  failedUpdate: '更新失败：{reason}',
  catalogTitle: '插件目录',
  catalogIdle: '搜索 GitHub 上标记为 dsh-plugin 的插件仓库。',
  catalogSearchLabel: '搜索插件目录',
  catalogSearchPlaceholder: '输入关键词，例如 sidebar',
  catalogSearch: '搜索',
  catalogSearching: '正在搜索…',
  catalogEmpty: '没有找到匹配的插件仓库。',
  catalogFailed: '搜索失败：{reason}',
  catalogMore: '加载更多',
  catalogStars: '{count} 星',
  catalogOpen: '在 GitHub 上打开 {name}',
  catalogInstall: '安装',
  catalogInstallLabel: '安装 {name}',
...
export const en = {
  ...
  installSpecPlaceholder: 'for example @qilin/experimental-auto-review',
  ...
  installGuideIdNote: 'The package name is the npm package name, usually qilin-xxx or @author/plugin; the display name is not one.',
  installGuideIdTitle: 'Package name',
  installGuideIdExample: '@qilin/experimental-auto-review',
  installGuideIdHint: 'The part after qilin plugin add or pnpm add in the README\'s install command.',
  ...
  installGuideSafety: 'Install only plugins you trust: they run with your permissions and can damage QiLin or leak your data.',
  installRun: 'Install',
  ...
  reasonStopProfile: 'This profile runs without HMR; stop it and uninstall the package with qilin plugin.',
  ...
  updatesCurrent: 'Everything is up to date.',
  updatesClose: 'Close the update results',
  updatesVersions: '{current} → {latest}',
  updatesFailed: 'The update check failed: {reason}',
  versionUnknown: 'unknown version',
  update: 'Update',
  updateLabel: 'Update {name}',
  failedUpdate: 'Could not update: {reason}',
  catalogTitle: 'Plugin catalog',
  catalogIdle: 'Search GitHub for repositories tagged dsh-plugin.',
  catalogSearchLabel: 'Search the plugin catalog',
  catalogSearchPlaceholder: 'Enter a keyword, for example sidebar',
  catalogSearch: 'Search',
  catalogSearching: 'Searching…',
  catalogEmpty: 'No plugin repository matched.',
  catalogFailed: 'The search failed: {reason}',
  catalogMore: 'Load more',
  catalogStars: '{count} stars',
  catalogOpen: 'Open {name} on GitHub',
  catalogInstall: 'Install',
  catalogInstallLabel: 'Install {name}',
