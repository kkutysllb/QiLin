...
import type { SettingsNamespaceView } from '@qilin/settings/types'
...
import { LOCALE_SETTINGS_NAMESPACE, LocaleSettingsSchema } from '@qilin/client-locale/src/locale-settings.ts'
