...
describe('Sidebar chat address', () => {
  it('round-trips the child identity and direct-parent routing metadata', () => {
    ...
    expect(resource).toBe('qilin-resource://subagentchat/session/child%231?parent=parent%2Fa&mode=continuable')
  ...
  it.each([
    ...
    'qilin-resource://other/session/child?parent=parent&mode=continuable',
    'qilin-resource://subagentchat/other/child?parent=parent&mode=continuable',
    'qilin-resource://subagentchat/session/child?mode=continuable',
    'qilin-resource://subagentchat/session/child?parent=&mode=continuable',
    'qilin-resource://subagentchat/session/child?parent=parent&mode=unknown',
    'qilin-resource://subagentchat/session/%?parent=parent&mode=continuable',
  ])('rejects %s', (address) => {
...
describe('Sidebar chat registration', () => {
  it('registers the resource, tab, and child slot and retains the child for the resource lifetime', async () => {
    ...
    expect(definition?.canOpen?.('qilin-resource://subagentchat/invalid')).toBe(false)
