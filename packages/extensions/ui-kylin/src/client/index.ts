/** Kylin dynamic-plugin cards, inventory panel, business-view host. */
...
export const inject = [
  'slots', 'locale', 'remote', 'remote.dynamicKylinRunner', 'dynamicKylinRunner',
]
...
export function apply(ctx: ClientContext): void {
  ...
  const inventory = createKylinInventory(port, (error) => {
    console.error('[ui-kylin] reading the Cordis inventory failed:', error)
  })
