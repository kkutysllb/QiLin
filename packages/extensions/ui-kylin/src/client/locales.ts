/**\*\* Kylin dynamic-plugin UI dictionaries. */
...
export const zh = {
  ...
  'panel.hint': '运行控制在左下角设置上方的\*\* Kylin 面板',
  'panel.plugins.aria': 'Kylin 插件',
  'panel.approvals.aria': 'Kylin 审批',
  'panel.trigger': 'Kylin Plugin',
  'panel.runningCount': '{count} running',
  'panel.title': 'Kylin 插件',
...
export type\*\* KylinKey = keyof typeof zh
...
export const en = {
  ...
  'row.removeTitle': 'Remove\*\* Kylin Plugin',
  ...
  'panel.hint': 'Run controls live in the\*\* Kylin panel above Settings',
  'panel.plugins.aria': 'Kylin plugins',
  'panel.approvals.aria': 'Kylin approvals',
  'panel.trigger': 'Kylin Plugin',
  'panel.runningCount': '{count} running',
  'panel.title': 'Kylin plugins',
  ...
  'body.copy': 'Copy',
  'body.copied': 'Copied',
} satisfies Record<KylinKey, string>
