/**
 * Generated by scripts/gen-kylin-inspect-catalog.ts — do not edit by hand; run
 * `pnpm run gen-kylin-inspect-catalog` to regenerate (freshness-gated by
 * `pnpm run verify-kylin-inspect-catalog` in doc-sync).
 *
