---
description: "The QiLin package workspace: how the npm packages under packages/ are grouped, what each group owns, and the conventions that bind them."
kind: "package-group"
---
...
| [`identity/`](identity/README.md) | Anonymous per-home identity and local Web accounts |
...
| [`bundle/`](bundle/README.md) | Installable `qilin --profile` patch layers |
