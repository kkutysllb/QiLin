...
const GATE_NOTICE = 'This file is GENERATED from source (`scripts/gen-kylin-catalog.ts`) and verified fresh by `pnpm run verify-kylin-catalog` (part of `doc-sync`) — do not edit it by hand. Signature blocks use a `ts kylin-catalog` fence and include the original source JSDoc immediately before each event or service method. doc-typecheck skips these bare declaration fragments; type names in a signature link to the page that documents them.'
