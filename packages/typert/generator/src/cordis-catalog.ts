...
export class CordisCatalogProjector {
  ...
  private collectEvents(): EventEntry[] {
    ...
    reportViolations('gen-kylin-catalog', violations)
    reportTypeLinkViolations('gen-kylin-catalog', typeLinkViolations)
    return entries
  }
...
export function projectCordisCatalog(scanRoot: string, policy: CordisCatalogPolicy, targetFace: TypertFace = 'host'): {
  ...
  if (face === undefined) throw new Error(`gen-kylin-catalog: Typert produced no ${targetFace} face`)
...
function renderRuntimeApi(
  ...
  const lines: string[] = [
    '/**',
    ' * Generated by scripts/gen-kylin-api.ts — do not edit by hand; run',
    ' * `pnpm run gen-kylin-api` to regenerate (freshness-gated by',
    ' * `pnpm run verify-kylin-api` in doc-sync).',
    ' *',
    ' * The machine-readable kylin API catalog `kylin_inspect` serves to the',
    ...
    ' * the same AST walk as docs/kylin-catalog, so this data and the rendered',
    ' * docs cannot diverge.',
    ' *',
    ...
    '}',
    '',
    '/** One inherited (kylin core + loader/hmr/timer) `ctx` member group with its summary. */',
  ...
  lines.push(
    ']',
    '',
    '/** The inherited `ctx` API (kylin core + loader/hmr/timer), in curated order. */',
...
export const REGION_BEGIN = '<!-- BEGIN GENERATED kylin-surface (gen-kylin-catalog.ts) — do not edit between markers -->'
/** Closing region delimiter matching {@link REGION_BEGIN}. */
export const REGION_END = '<!-- END GENERATED kylin-surface -->'
...
const GATE_NOTICE = 'This file is GENERATED from source (`scripts/gen-kylin-catalog.ts`) and verified fresh by `pnpm run verify-kylin-catalog` (part of `doc-sync`) — do not edit it by hand. Signature blocks use a `ts cordis-catalog` fence and include the original source JSDoc immediately before each event or service method. doc-typecheck skips these bare declaration fragments; type names in a signature link to the page that documents them.'
