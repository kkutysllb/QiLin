...
The generated [configuration catalog](../../../docs/config-catalog.md#deepseek-aiqilin-tool-session-query) is the exhaustive source for every accepted field and its JSDoc.
...
- [Generated tool catalog](../../../docs/tool-catalog.md#deepseek-aiqilin-tool-session-query) — the five tool schemas as the model sees them.
