...
The generated [configuration catalog](../../../docs/config-catalog.md#deepseek-aiqilin-session-query-sqlite) is the exhaustive source for every accepted field and its JSDoc.
