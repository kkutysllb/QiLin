        ...
        <div className="flex flex-1 flex-col overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900/50">
          ...
          <div className="border-b border-zinc-800 p-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-zinc-400">KWorks Agent</span>
            </div>
          </div>
                ...
                >
                  ...
                  {[
                    ...
                    <div className="text-base text-zinc-300">
                      <span className="text-purple-400">✨</span> 找到 3 个技能
                    </div>
                  )}
                      ...
                      <div className="mb-3 space-y-2">
                        ...
                        {[
                          ...
                          <div className="flex items-center gap-2 pl-4 text-zinc-400">
                            <FileText size={16} />
                            <span>正在加载 deep-search/SKILL.md...</span>
                          </div>
                        )}
                        {/* Loading biotech.md */}
                        {[
                  ...
                  {["building", "load-deploy", "deploying", "done"].includes(
                    ...
                    >
                      <hr className="mb-3 border-zinc-700" />
                      <div className="mb-3 text-zinc-300">🔨 正在构建...</div>
                      <div className="mb-3 flex items-center gap-2 pl-4 text-zinc-400">
                        <FileText size={16} />
                        <span>正在加载 frontend-design/SKILL.md...</span>
                      </div>
                  ...
                  {["load-deploy", "deploying", "done"].includes(phase) && (
                    ...
                    >
                      <hr className="mb-3 border-zinc-700" />
                      <div className="mb-3 text-zinc-300">🚀 正在部署...</div>
                      <div className="mb-3 space-y-2">
                        <div className="flex items-center gap-2 pl-4 text-zinc-400">
                          <FileText size={16} />
                          <span>正在加载 deploy/SKILL.md...</span>
                        </div>
                        {["deploying", "done"].includes(phase) && (
                          ...
                          >
                            <Terminal size={16} />
                            <span>正在执行 scripts/deploy.sh</span>
                          </motion.div>
                        )}
                      </div>
                      {phase === "done" && (
                        ...
                        >
                          <div className="text-lg font-medium text-green-500">
                            ✅ 已上线 biotech-startup.vercel.app
                          </div>
                        </motion.div>
                      )}
                    </motion.div>
