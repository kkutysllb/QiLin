...
/**
 * Plugins management content (H3-b) - npm install / list / enable /
 * disable / remove DSH third-party plugins via the loopback management
 * API on the web-demo server. Shared by the settings section
 * (settings-view) and the standalone /workspace/plugins route.
 * Every mutation requires a web-demo restart to take effect
