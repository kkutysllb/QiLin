...
description: The KWorks App workspace is a browser-based interface for having multi-turn conversations with the agent, tracking task progress, viewing artifacts, and managing files.
---
...
The KWorks App workspace is a browser-based interface for having multi-turn conversations with the agent, tracking task progress, viewing artifacts, and managing files.

## Starting a conversation

Open the app at `http://localhost:9191` (or your deployment URL). The workspace is split into:
...
<Cards num={2}>
  <Cards.Card
    ...
    href="/en/docs/application/agents-and-threads"
  />
