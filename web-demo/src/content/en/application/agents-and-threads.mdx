...
In Docker deployments, this path is bind-mounted from the host so that thread data persists across container restarts. Set `QILIN_ROOT` to the absolute path of your KWorks repository root to ensure the correct host path is used.
