...
description: This tutorial guides you through deploying QiLin to a production environment using Docker Compose for multi-user access.
---

import { Callout, Steps } from "nextra/components";

# Deploy Your Own QiLin

This tutorial guides you through deploying QiLin to a production environment using Docker Compose for multi-user access.
...
- Back up `backend/.qilin/` directory regularly
