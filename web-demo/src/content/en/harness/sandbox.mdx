...
<Callout type="info" emoji="📦">
  ...
  command-based work. It is what makes QiLin capable of real action, not just
  conversation.
</Callout>
...
QiLin supports three sandbox modes. Choose the one that fits your deployment:
...
sandbox:
  ...
  # Optional: container name prefix (default: kworks-sandbox)
  container_prefix: kworks-sandbox
...
| `.qilin/threads/{thread_id}/user-data/` | `/mnt/user-data/`                            | Read-write |
