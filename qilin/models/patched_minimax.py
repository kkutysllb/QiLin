...
``langchain_openai.ChatOpenAI`` currently ignores that field, so QiLin's
...
which QiLin already understands.
"""
...
class PatchedChatMiniMax(ChatOpenAI):
    ...
    def _strip_user_message_names(payload: dict) -> None:
        ...
        QiLin middlewares tag user messages with internal provenance names
