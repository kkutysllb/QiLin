...
from qilin.utils.network import get_free_port, release_port
...
def _resolve_docker_bind_host(
    ...
    narrower bind with ``QILIN_SANDBOX_BIND_HOST``.  When operators choose
...
class LocalContainerBackend(SandboxBackend):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            container_prefix: Prefix for container names (e.g., "qilin-sandbox").
    ...
    def create(
        ...
        *,
        ...
        sandbox_host = os.environ.get("QILIN_SANDBOX_HOST", "localhost")
        return SandboxInfo(
