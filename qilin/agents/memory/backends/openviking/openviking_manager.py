...
memory search results back to QiLin's backend-neutral shapes.
"""
...
_SESSION_NAMESPACE = "qilin-openviking-v1"
...
class OpenVikingMemoryManager(MemoryManager):
    ...
    def _identity(self, user_id: str | None, agent_name: str | None) -> OpenVikingIdentity:
        ...
        # QiLin scope also prevents raw emails/usernames from leaving the
