...
from qilin.config.extensions_config import ExtensionsConfig, McpOAuthConfig
...
class OAuthTokenManager:
    ...
    def __init__(self, oauth_by_server: dict[str, McpOAuthConfig]):
        ...
        # path (QiLinClient.stream() -> LangGraph ToolNode._func -> a
        # ThreadPoolExecutor -> qilin.tools.sync.make_sync_tool_wrapper's
