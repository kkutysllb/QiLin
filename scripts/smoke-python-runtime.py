...
def smoke_sdk_office(executable: Path) -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="qilin-sdk-office-") as temporary:
        ...
        with DeepSeekHarness(
            ...
            model="smoke-model",
            cwd=str(root),
            qilin_bin=str(relocated),
            qilin_home=str(root / f"home-{mode}"),
            patches=(str(patch),),
            api_key="sk-keyless-smoke",
            base_url="http://127.0.0.1:9",
            env={"QILIN_PERMISSION_MODE": "danger-full-access", "QILIN_TELEMETRY_DISABLED": "1"},
