...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/typert/registry': { kind: 'none', reason: 'Runtime type registry; consumers (kylin_inspect, wire faces, gates) own any model-visible projection of registry contents.' },
