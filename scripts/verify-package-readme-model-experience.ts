...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/shell/shell': { kind: 'indirect', reason: 'The service interface delegates all model rendering to qilin-tool-bash.' },
  'packages/shell/shell-env': { kind: 'indirect', reason: 'The env service exposes managed QILIN_* facts through the shell tools (qilin-tool-bash/qilin-tool-pwsh); it registers no prompt or schema of its own.' },
  'packages/shell/bash-local': { kind: 'indirect', reason: 'The executor backend delegates model rendering to qilin-tool-bash.' },
  'packages/shell/pwsh-local': { kind: 'indirect', reason: 'The executor backend delegates model rendering to qilin-tool-pwsh.' },
  'packages/ptc-runtime/ptc-runtime': { kind: 'indirect', reason: 'The service interface delegates model rendering to PTC mode in qilin-tools.' },
  'packages/core/agent-tool-presentation': { kind: 'indirect', reason: 'The row only selects between the two projections qilin-tools owns; it registers no prompt, schema, or result of its own.' },
  'packages/ptc-runtime/ptc-runtime-node': { kind: 'indirect', reason: 'The Node process backend delegates model rendering to PTC mode in qilin-tools.' },
  'packages/experimental/ptc-runtime-python': { kind: 'indirect', reason: 'Explicit source-checkout compositions delegate model rendering to PTC mode in qilin-tools.' },
  ...
  'packages/util/dsh-compat': { kind: 'none', reason: 'The compatibility layer maps DSH-era manifest keys and module names; it changes no prompt, tool schema, session event, or token budget.' },
  ...
  'packages/llm/deepseek-llm-api-extensions': { kind: 'indirect', reason: 'The registry contributes model-hidden provider fields; qilin-llm-deepseek owns their wire placement.' },
  ...
  'packages/client/ui-account': { kind: 'none', reason: 'The account menu renders browser chrome and routes sign-in and sign-out through the session Remote; it registers no prompt text, tool, or session event.' },
  'packages/client/ui-brand': { kind: 'none', reason: 'The brand seal is browser presentation; it registers no prompt text, tool, or session event.' },
  'packages/client/ui-settings-mcp': { kind: 'none', reason: 'The page writes the user patch layer through the mcpServers Remote; the composition that mounts the patched layer owns every model-facing tool definition.' },
  ...
  'packages/fs/fs': { kind: 'indirect', reason: 'The service interface delegates model rendering to qilin-tool-fs.' },
  'packages/fs/fs-local': { kind: 'indirect', reason: 'The provider backend delegates model rendering to qilin-tool-fs.' },
  ...
  'packages/webhook/webhook-github': { kind: 'indirect', reason: 'The adapter delegates model-visible text to matching rules and qilin-webhook.' },
  ...
  'packages/lsp/lsp': { kind: 'indirect', reason: 'The provider registry delegates model rendering to qilin-tool-lsp.' },
  'packages/lsp/lsp-stdio': { kind: 'indirect', reason: 'The provider backend delegates model rendering to qilin-tool-lsp.' },
  ...
  'packages/sandbox/sandbox-local': { kind: 'indirect', reason: 'The provider backend delegates model rendering to qilin-bash-sandbox and qilin-tool-bash.' },
  ...
  'packages/identity/accounts-local': { kind: 'none', reason: 'Accounts gate the browser surface through stored credentials; the package assembles no provider request and registers no prompt text, tool, or session event.' },
  'packages/skill/skill': { kind: 'indirect', reason: 'The provider registry delegates model rendering to qilin-tool-skill.' },
  'packages/skill/skill-badge': { kind: 'indirect', reason: 'The bundled provider delegates model rendering to qilin-tool-skill.' },
  'packages/skill/skill-office': { kind: 'indirect', reason: 'The bundled Office provider delegates model rendering to qilin-tool-skill.' },
  'packages/skill/skill-filesystem': { kind: 'indirect', reason: 'The provider backend delegates model rendering to qilin-tool-skill.' },
  ...
  'packages/jobs/jobs-local': { kind: 'indirect', reason: 'The registry backend delegates model rendering to producer plugins and qilin-tool-jobs.' },
  ...
  'packages/interaction/permission-presets': { kind: 'indirect', reason: 'The service writes mechanism events rendered by qilin-user-approval and qilin-tool-bash.' },
  ...
  'packages/web/web': { kind: 'indirect', reason: 'The provider registry delegates model rendering to qilin-tool-web.' },
  'packages/web/web-fetch-http': { kind: 'indirect', reason: 'The provider backend delegates model rendering to qilin-tool-web.' },
  'packages/web/web-search-exa': { kind: 'indirect', reason: 'The provider backend delegates model rendering to qilin-tool-web.' },
